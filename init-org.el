...
(with-eval-after-load "org"
	...
	;; "k" でツリーをカットする時に，統計情報を更新する
	(defun my-k-update-todo-statistics (&optional _arg)
		(org-update-statistics-cookies nil)
		(org-update-parent-todo-statistics))
	(advice-add 'org-cut-subtree :after #'my-k-update-todo-statistics)

	;; "y" でツリーをペーストする時に，統計情報を更新する
	(defun my-y-update-todo-statistics (&optional _arg)
		(org-previous-visible-heading 1)
		(my-k-update-todo-statistics)
