...
(when (autoload-if-found '(my-toggle-bm
  ...
  (with-eval-after-load "bm"
    ...
    (setq bm-repository-file
          (expand-file-name
           (concat my-sync-dir "/usr/emacs.d/.bm-repository")))
  ...
  (with-eval-after-load "ispell"
    ...
    (cond
     ((executable-find "hunspell")
      ...
      (setenv "DICPATH" (concat my-sync-dir "/usr/emacs.d/hunspell/dict-en"))
      ...
      (setq ispell-personal-dictionary
            (concat my-sync-dir "/usr/emacs.d/hunspell.en.dic")))
     ...
     ((executable-find "aspell")
      ...
      (setq ispell-personal-dictionary
            (concat my-sync-dir "/usr/emacs.d/config/aspell.en.pws")))
     (t
      nil))))
...
(when (autoload-if-found '(flyspell-mode-on
  ...
  (with-eval-after-load "flyspell"
    ...
    ;; [FIXME] nextstep+inline-patch版で flyspell すると，日本語nyuuのようになる場合がある．入力中に flyspell を無効化して回避．
...
(when (autoload-if-found '(keyfreq-mode keyfreq-autosave-mode my--keyfreq-show)
  ...
  (with-eval-after-load "keyfreq"
    ...
    (setq keyfreq-file
          (expand-file-name (concat my-sync-dir "/usr/emacs.d/.keyfreq")))
